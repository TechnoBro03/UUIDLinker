...
function uuid_linker:string_helper2 with storage uuid_linker Hex
...
execute unless score .count UUIDLinker matches 0 run function uuid_linker:string_helper